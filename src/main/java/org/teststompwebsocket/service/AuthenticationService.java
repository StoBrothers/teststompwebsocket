...
public class AuthenticationService {
    ...
    public AuthenticationMsg handleMessage(AuthenticationMsg message, String username, String simpSessionId) {
        ...
        if (!AuthenticationService.checkDataSection(dataMap)) {
     ...
     * @return
     */
    public static boolean checkDataSection(Map<String, String> dataMap) {
     ...
     */
    @Transactional
    public void updateActiveToken(String simpSessionId, WSToken newToken) {
